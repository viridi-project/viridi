...
/** Fees smaller than this (in uviridi) are considered zero fee (for relaying and mining)
...
CAmount GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight <= Params().LAST_POW_BLOCK() && nHeight > Params().ANTI_INSTAMINE_TIME()) {
        return 5.7 * COIN;
      // POS Year 1

...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 2706, 12706));
    ...
    strUsage += HelpMessageOpt("-anonymizeviridiamount=<n>", strprintf(_("Keep N VIRIDI anonymized (default: %u)"), 0));

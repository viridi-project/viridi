...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"viridiprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"viridiprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"viridiaddress\"\n"
            "\nReveals the private key corresponding to 'viridiaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"viridiaddress\"   (string, required) The viridi address for the private key\n"
            "\nResult:\n"
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"viridiaddress\"\n"
            "\nEncrypts a private key corresponding to 'viridiaddress'.\n"
            "\nArguments:\n"
            "1. \"viridiaddress\"   (string, required) The viridi address for the private key (you must hold the key already)\n"

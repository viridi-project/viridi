...
TRANSLATIONS += src/qt/locale/viridi_bg.ts \
                src/qt/locale/viridi_de.ts \
                src/qt/locale/viridi_en.ts \
                src/qt/locale/viridi_es.ts \
                src/qt/locale/viridi_fi.ts \
                src/qt/locale/viridi_fr.ts \
                src/qt/locale/viridi_it.ts \
                src/qt/locale/viridi_ja.ts \
                src/qt/locale/viridi_pl.ts \
                src/qt/locale/viridi_pt.ts \
                src/qt/locale/viridi_ru.ts \
                src/qt/locale/viridi_sk.ts \
                src/qt/locale/viridi_sv.ts \
                src/qt/locale/viridi_vi.ts \
                src/qt/locale/viridi_zh_CN.ts \
                src/qt/locale/viridi_zh_TW.ts

...
- [Building VIRIDI](#building-viridi)
...
Clone the git repositories for viridi and gitian and then checkout the viridi version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/viridi-crypto/viridi.git
cd viridi
...
Follow the instructions in [doc/release-process.md](release-process.md) in the viridi repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the viridi repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/viridi/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/viridi-crypto/viridi
...
For example:
```bash
URL=https://github.com/crowning-/viridi.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit viridi=${COMMIT} --url viridi=${URL} ../viridi/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit viridi=${COMMIT} --url viridi=${URL} ../viridi/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit viridi=${COMMIT} --url viridi=${URL} ../viridi/contrib/gitian-descriptors/gitian-osx.yml
```
...
[viridi/gitian.sigs](https://github.com/viridi-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.

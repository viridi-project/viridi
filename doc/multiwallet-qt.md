...
Only requiring some minor changes is viridi.cpp.
...
Changes to viridi.cpp
----------------------
viridi.cpp is the entry point into viridi-qt, and as such, will require some minor modifications to provide hooks for
